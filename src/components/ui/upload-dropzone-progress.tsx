      ...
      <div className="grid gap-2">
        {progresses.map((progress) => (
          <div
            ...
            className={cn("dark:bg-input/10 flex items-center gap-2 rounded-lg border bg-transparent p-3", {
...
function FileIcon({ type }: { type: string }) {
  ...
  return (
    <div className="relative shrink-0">
      ...
      {caption && (
        <span className="bg-primary text-primary-foreground absolute bottom-2.5 left-0.5 rounded px-1 py-px text-xs font-semibold select-none">
          {caption}
        </span>
      )}
    </div>
